...
@referers = ('thetorahspring.org','71.179.89.92');
...
sub check_captcha {
      ...
      {
          privatekey => '6LehufkSAAAAABLrGZ5mgdRl2qa0QOJrj2epZH0n',
...
sub parse_form {
    ...
    %Config = ('recipient','yehuda@ymkatz.net',          'subject','TheTorahSpring.org Contact Form',
               'email','',              'realname','',
               'redirect','/contact-thanks.html',           'bgcolor','',
